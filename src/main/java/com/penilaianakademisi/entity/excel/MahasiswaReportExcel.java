...
public class MahasiswaReportExcel {

    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private Set<Mahasiswa> reports;
    private SortedSet<Mahasiswa> sortedData;
    private MahasiswaAplusMin aPlusMin;

    public MahasiswaReportExcel(Set<Mahasiswa> reports, SortedSet<Mahasiswa> sortedData, MahasiswaAplusMin aPlusMin ) {
        workbook = new XSSFWorkbook();
        sheet = workbook.createSheet("MahasiswaReport");
